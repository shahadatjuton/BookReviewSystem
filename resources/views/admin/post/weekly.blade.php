            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2>
                            TOTAL POSTS
                            <span class="badge bg-blue">{{ $weekly_posts->count() }}</span>
                            <div class="pull-right "><a href="{{route('admin.report.post.weekly')}}" class="btn btn-success"> Generate Last Week Post Report </a></div>
                    ...
                    <div class="body">
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                ...
                                @foreach($weekly_posts as $key=> $post)
