            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2>
                            TOTAL SUBSCRIBERS
                            <span class="badge bg-blue">{{ $last_months_subscriber->count() }}</span>
                            <div class="pull-right "><a href="{{route('admin.report.subscriber.monthly')}}" class="btn btn-success"> Generate Subscriber Report </a></div>
                    ...
                    <div class="body">
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                ...
                                @foreach($last_months_subscriber as $key=> $subscriber)
                                    <tr>
                                        <td>{{ $key +1 }}</td>
